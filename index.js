...
function addGamesToPage(games) {
    ...
    for (let game of games) {
        ...
        document.getElementById("games-container").appendChild(gameCardContainer)
    }
...
const displayStr = `A total of $${totalAmount.toLocaleString('en-US')} has been
   raised for ${GAMES_JSON.length} ${(GAMES_JSON.length) > 1 ? "games" : "game"}.
   Currently, ${numUnfundedGames} ${numUnfundedGames > 1 ? "games remain" : "game remains"}
   unfunded. We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
const descriptionTag = document.createElement('p')
descriptionTag.textContent = displayStr
